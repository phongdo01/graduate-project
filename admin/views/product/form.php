        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                ...
                <input name="createdate" type="date" value="<?php echo $product ? $product['Createdate'] : ''; ?>"
                       class="form-control" id="createdate"  min="2015-01-02" max="2025-05-06"/>
            </div>
        </div>

        <div class="form-group">
            <label for="createdate" class="col-sm-3 control-label">Số lượng hiện có</label>

            <div class="col-sm-9">

                <input name="quantity" type="number" value="<?php echo $product ? $product['quantity'] : ''; ?>"
                       class="form-control" />
            </div>
        </div>
